...
export declare class AuthService {
    ...
    private readonly authOtpRepository;
    private readonly jwt;
    private readonly config;
    private readonly mailer;
    private readonly settings;
    private readonly logger;
    constructor(userService: UserService, authOtpRepository: Repository<AuthOtp>, jwt: JwtService, config: ConfigService, mailer: MailerService, settings: SettingsService);
