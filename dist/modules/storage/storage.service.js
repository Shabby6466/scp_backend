...
const s3_storage_driver_1 = require("./s3-storage.driver");
const supabase_storage_driver_1 = require("./supabase-storage.driver");
let StorageService = class StorageService {
    constructor(config) {
        ...
        this.driver =
            provider === 's3'
                ? new s3_storage_driver_1.S3StorageDriver(this.config)
                : new supabase_storage_driver_1.SupabaseStorageDriver(this.config);
    }
