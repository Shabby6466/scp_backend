...
exports.BranchModule = BranchModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [branch_service_js_1.BranchService, branch_dashboard_service_js_1.BranchDashboardService],
        exports: [branch_service_js_1.BranchService, branch_dashboard_service_js_1.BranchDashboardService],
    })
], BranchModule);
